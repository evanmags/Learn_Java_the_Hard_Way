public class HeronsFormula{
  public static void main( String[] args){
    ...
    System.out.println(tws + "3, 3, 3 has area " + a);

    a = triangleArea(3, 4, 5);
    System.out.println(tws + "3, 4, 5 has area " + a);
  ...
  // this function will compute the area of a triange with sides a, b, c
  public static double triangleArea(int a, int b, int c){
    ...
    //After computing you must return the computed value
    return A;
  }
}